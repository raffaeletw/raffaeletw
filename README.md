...
**Master’s graduate in Computer Science and Information Engineering**  
from National Taiwan University of Science and Technology  

**Developer**  
I have a strong programming background and a passion for practical applications. My expertise spans **Python (AI/ML)**, **Java (Spring)**, and **Database Systems**.
...
**Some Projects**:
- **Malware Detection with AI**: Developed a system to detect malicious packets with 92% accuracy.  
